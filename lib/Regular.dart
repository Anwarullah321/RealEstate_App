...
class Regular_Listings extends StatefulWidget {
  const Regular_Listings({Key? key, }) : super(key: key);

  @override
  State<Regular_Listings> createState() => _Regular_ListingsState();
}

class _Regular_ListingsState extends State<Regular_Listings> {
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      child: StreamBuilder<DatabaseEvent>(
                          stream: ref.orderByChild('name').equalTo('Regular').onValue,
